...
INSERT INTO orders (useremail, productname, quantity, price, totalprice, status, orderdate) VALUES ('alice@pepsico.com', 'Doritos Spicy Jalapeño Poppers', 1, 5.49, 5.49, 'CREATED', '02-01-2025');
INSERT INTO orders (useremail, productname, quantity, price, totalprice, status, orderdate) VALUES ('alice@pepsico.com', 'Cheetos Cheddar Cheese Puffs', 3, 3.99, 11.97, 'CREATED', '03-01-2025');
INSERT INTO orders (useremail, productname, quantity, price, totalprice, status, orderdate) VALUES ('alice@pepsico.com', 'Smartfood Dark Chocolate Almonds', 1, 6.99, 6.99, 'CREATED', '04-01-2025');
INSERT INTO orders (useremail, productname, quantity, price, totalprice, status, orderdate) VALUES ('alice@pepsico.com', 'Rold Gold Pretzel', 2, 3.49, 6.98, 'CREATED', '05-01-2025');
INSERT INTO orders (useremail, productname, quantity, price, totalprice, status, orderdate) VALUES ('alice@pepsico.com', 'Fritos Corn Chips', 4, 2.99, 11.96, 'CREATED', '06-01-2025');
